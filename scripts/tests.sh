...
function download_aleth()
{
    if [[ "$OSTYPE" == "darwin"* ]]; then
        ...
        ALETH_HASH="8db2019d3185c78e3043f211d0a360aff450a7f4"
        wget -q -O /tmp/test/aleth.tar.gz https://github.com/ethereum/aleth/releases/download/v1.4.0rc7/aleth-1.4.0rc6+commit.d7e94caa-linux-x86_64.tar.gz
